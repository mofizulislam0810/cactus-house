              ...
              <div class="card h-100 shadow">
                ...
                <div class="card-body">
                  ...
                  <div class="text-center my-4">
                    <a href="updateorder.php?update=<?php echo $id;?>" class="btn btn-outline-success me-2 shadow">
                      Please Confirm
                    </a>
                    <a href="deleteorder.php?del=<?php echo $id;?>" class="btn btn-outline-success shadow">
                      Delete
                    </a>
                  </div>
                </div>
